...
## Три ловушки при сборке состояния

Все три найдены тестами на эталонной партии, каждая давала тихо неверный результат.
...
**3. Одинаковые имена тегов приходят на разные сущности с разным смыслом.**
