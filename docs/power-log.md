...
Статус: ✅ **механизм подтверждён на живом клиенте** (лог умер на 53 189 байт при
лимите 44 КБ). Осталось подтвердить обратное — что при 1000000 КБ полная партия BG
проходит без обрыва.
