...
**Последний полный прогон:** 2026-09-22 22:00, коммит 5b678b7, зерно 1, партий 52 (part4–part55).
**Сравнивается с:** 2026-09-22 17:24, коммит 96ef957, зерно 1, партий 52 (part4–part55).
**Полосы шума нет:** `npm run battery -- --seeds=5` посчитает её один раз на коде.

## validate:tavern · 58 мин

| метрика | было | стало | Δ | шум (SD) | |
|---|---:|---:|---:|---:|---|
| turns | 519 | 519 | 0 | — | без изменений |
| agreementPct | 75.5 | 75.3 | -0.2 | — | изменилось |
| costPp | 3.13 | 3.12 | -0.01 | — | изменилось |
| decisiveTurns | 179 | 179 | 0 | — | без изменений |
| decisiveAgreementPct | 52.5 | 52.5 | 0 | — | без изменений |
| decisiveCostPp | 8.89 | 8.86 | -0.03 | — | изменилось |
...
| outOfSampleAgreementPct | 75.4 | 75.1 | -0.3 | — | изменилось |
| outOfSampleCostPp | 3.19 | 3.18 | -0.01 | — | изменилось |
| skippedNoBattle | 9 | 9 | 0 | — | без изменений |
| skippedNoChoice | 136 | 136 | 0 | — | без изменений |

## validate:spend · 80 мин
