 ...
 *
 * **Первый прогон, 25.09:** 29 боёв part64–part76, 0.091 → 0.095 (ручной
 * прогон до скрипта, с зерном без хэша входа, — 0.096); с part77 — 36 боёв,
 * 0.077 → 0.085. Не принято по обоим условиям. Больше всего минуса дал один
 * бой: part64 ход 20 (74 → 30 %, бой выигран).
 *
