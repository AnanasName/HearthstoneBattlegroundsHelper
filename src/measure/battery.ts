 ...
 *
 * Умолчание — половина ядер, но не больше числа задач: каждая задача держит
 * свой снапшот карт (10 МБ JSON, куча 123 МБ), и восемь процессов
 * на шестнадцатиядерной машине оставляют запас и памяти, и ядер под тесты
 * соседней сессии.
